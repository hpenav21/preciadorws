...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__wsupdate_prices_update_wsprices_component__ = __webpack_require__("../../../../../src/app/wsupdate-prices/update-wsprices.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20_rxjs_add_observable_of__ = __webpack_require__("../../../../rxjs/add/observable/of.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20_rxjs_add_observable_of___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_20_rxjs_add_observable_of__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21_rxjs_add_observable_throw__ = __webpack_require__("../../../../rxjs/add/observable/throw.js");
...
var routes = [
    ...
    { path: 'wsUpdatePrices/:id', component: __WEBPACK_IMPORTED_MODULE_15__wsupdate_prices_update_wsprices_component__["a" /* WsUpdatePricesComponent */] },
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_15__wsupdate_prices_update_wsprices_component__["a" /* WsUpdatePricesComponent */],
        ],
        imports: [
...
var LedcommandsComponent = (function () {
    ...
    LedcommandsComponent.prototype.getPricesFromFile = function () {
        ...
        var thisRef = this;
        /*
        this.http.get('http://localhost:8000/archivo/a').subscribe(data => {
          // Read the result field from the JSON response.
           var obj:any = data;
    
           this.parseFileCRE(obj.prices)
           //this.setPrices();
        });
        */
    };
...
/***/ "../../../../../src/app/wsupdate-prices/update-wsprices.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../src/app/wsupdate-prices/update-wsprices.component.html":
/***/ (function(module, exports) {

module.exports = "<router-outlet></router-outlet>\n<div id=\"Layer1\" style=\"position:fixed;text-align:center;left:0;top:0;right:0;bottom:0;z-index:8;\">\n    <div id=\"Layer1_Container\" style=\"width:970px;position:relative;margin-left:auto;margin-right:auto;text-align:left;\">\n        <div id=\"wb_Image1\" style=\"position:absolute;left:0px;top:0px;width:162px;height:107px;z-index:0;\">\n            <img src=\"assets/images/pemex-logo-256488E18E-seeklogo.com.png\" id=\"Image1\" alt=\"\"></div>\n        <div id=\"wb_Image2\" style=\"position:absolute;left:189px;top:164px;width:295px;height:71px;z-index:1;\">\n            <img src=\"assets/images/1262197214_pemex_premium.jpg\" id=\"Image2\" alt=\"\"></div>\n        <div id=\"wb_Image3\" style=\"position:absolute;left:189px;top:243px;width:295px;height:59px;z-index:2;\">\n            <img src=\"assets/images/magna.jpg\" id=\"Image3\" alt=\"\"></div>\n        <div id=\"wb_Image4\" style=\"position:absolute;left:189px;top:309px;width:295px;height:70px;z-index:3;\">\n            <img src=\"assets/images/diesel.jpg\" id=\"Image4\" alt=\"\"></div>\n        <div id=\"wb_Text2\" style=\"position:absolute;left:275px;top:23px;width:421px;height:33px;text-align:center;z-index:6;\">\n            <span style=\"color:#F5FFFA;font-family:'Roboto Black';font-size:27px;\"><strong>Pantalla Actualización de Precios</strong></span></div>\n        <div id=\"wb_Text3\" style=\"position:absolute;left:503px;top:164px;width:158px;height:63px;text-align:center;z-index:7;\">\n            <span style=\"color:#696969;font-family:'Roboto Black';font-size:53px;\"><strong>{{premium}}</strong></span></div>\n        <div id=\"wb_Text1\" style=\"position:absolute;left:503px;top:241px;width:158px;height:63px;text-align:center;z-index:4;\">\n            <span style=\"color:#696969;font-family:'Roboto Black';font-size:53px;\"><strong> {{magna}}</strong></span></div>\n        <div id=\"wb_Text4\" style=\"position:absolute;left:503px;top:309px;width:158px;height:63px;text-align:center;z-index:5;\">\n            <span style=\"color:#696969;font-family:'Roboto Black';font-size:53px;\"><strong>{{diesel}}</strong></span></div>\n    </div>\n</div>"

/***/ }),

/***/ "../../../../../src/app/wsupdate-prices/update-wsprices.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return WsUpdatePricesComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__("../../../router/@angular/router.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_common_http__ = __webpack_require__("../../../common/@angular/common/http.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_common__ = __webpack_require__("../../../common/@angular/common.es5.js");
...
var WsUpdatePricesComponent = (function () {
    function WsUpdatePricesComponent(http, decPipe, router) {
        this.http = http;
        this.decPipe = decPipe;
        this.router = router;
        this.magna = "";
    ...
    WsUpdatePricesComponent.prototype.ngOnInit = function () {
        var ledComponent = new __WEBPACK_IMPORTED_MODULE_4__ledcommands_ledcommands_component__["a" /* LedcommandsComponent */](this.http, this.decPipe, this.router);
        console.log("update prices component...");
        try {
            this.readUpdatedPrices();
            //this.magna = pricesObj.magna;
            //this.premium = pricesObj.premium;
            //this.diesel = pricesObj.diesel;
        }
        catch (err) {
            this.magna = "";
            this.premium = "";
    ...
    WsUpdatePricesComponent.prototype.readUpdatedPrices = function () {
        ...
        this.http.get('http://104.154.33.238:8080/archivo/a').subscribe(function (data) {
            ...
            _this.magna = _this.validate(prices.magna);
            _this.premium = _this.validate(prices.premium);
            _this.diesel = _this.validate(prices.diesel);
        });
    };
    WsUpdatePricesComponent.prototype.validate = function (price) {
        var result = "";
        if (price == undefined) {
            result = "";
        }
            ...
            result = this.decPipe.transform(price, "2.2-2"); //reference-->> https://angular.io/api/common/DecimalPipe    2.2-2 -->> Max Integers 2; MinDecimal Places 2; MaxDecimal Places 2
        }
        return result;
    };
    return WsUpdatePricesComponent;
}());
WsUpdatePricesComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'app-wsupdate-prices',
        template: __webpack_require__("../../../../../src/app/wsupdate-prices/update-wsprices.component.html"),
        styles: [__webpack_require__("../../../../../src/app/wsupdate-prices/update-wsprices.component.css")]
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["a" /* HttpClient */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["a" /* HttpClient */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_3__angular_common__["DecimalPipe"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__angular_common__["DecimalPipe"]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* ActivatedRoute */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* ActivatedRoute */]) === "function" && _c || Object])
], WsUpdatePricesComponent);

var _a, _b, _c;
//# sourceMappingURL=update-wsprices.component.js.map
